...
const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,689,128. The last known price of Bitcoin is 66,895.23316621 USD and is up 1.20 over the last 24 hours. It is currently trading on 11017 active market(s) with $25,831,653,595.92 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
  ...
  '825': {
    ...
    category: 'token',
    description:
      'Tether USDt (USDT) is a cryptocurrency and operates on the Ethereum platform. Tether USDt has a current supply of 112,941,048,614.41264 with 109,840,251,114.81395 in circulation. The last known price of Tether USDt is 1.00052965 USD and is down -0.02 over the last 24 hours. It is currently trading on 83819 active market(s) with $50,141,312,243.47 traded over the last 24 hours. More information can be found at https://tether.to.',
    slug: 'tether',
  ...
  '1027': {
    ...
    category: 'coin',
    description:
      'Ethereum (ETH) is a cryptocurrency . Ethereum has a current supply of 122,044,084.87291023. The last known price of Ethereum is 3,247.69295306 USD and is up 1.97 over the last 24 hours. It is currently trading on 8855 active market(s) with $11,368,778,696.39 traded over the last 24 hours. More information can be found at https://www.ethereum.org/.',
    slug: 'ethereum',
  ...
  '1839': {
    ...
    category: 'coin',
    description:
      'BNB (BNB) is a cryptocurrency . BNB has a current supply of 149,532,931.45810148. The last known price of BNB is 606.44109498 USD and is up 1.60 over the last 24 hours. It is currently trading on 2151 active market(s) with $1,309,826,933.08 traded over the last 24 hours. More information can be found at https://bnbchain.org/en.',
    slug: 'bnb',
  ...
  '5426': {
    ...
    category: 'coin',
    description:
      'Solana (SOL) is a cryptocurrency launched in 2020. Solana has a current supply of 574,605,890.235416 with 447,051,618.4656949 in circulation. The last known price of Solana is 158.29905812 USD and is up 3.09 over the last 24 hours. It is currently trading on 655 active market(s) with $2,644,386,205.95 traded over the last 24 hours. More information can be found at https://solana.com.',
    slug: 'solana',
